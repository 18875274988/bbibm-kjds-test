...
import com.rjkj.cf.bbibm.kjds.goods.reqvo.QueryEnabledStoresVo;
...
//    @PreAuthorize("@pms.hasPermission('goods_goods_del')" )
    ...
    @GetMapping("queryEnabledStores")
    @ApiOperation(value = "查询所有启用商铺ID和地区", notes = "查询所有启用商铺ID和地区")
    public R queryEnabledStores(){
       return R.ok(goodsService.queryEnabledStores());
